...
/*   9:    */ import net.minecraft.server.v1_7_R1.DamageSource;
/*  10:    */ import net.minecraft.server.v1_7_R1.EntityDamageSource;
/*  11:    */ import net.minecraft.server.v1_7_R1.EntityPlayer;
/*  12:    */ import net.minecraft.server.v1_7_R1.EntitySlime;
/*  13:    */ import net.minecraft.server.v1_7_R1.NBTTagCompound;
...
/* 142:    */   {
/* 143:166 */     if ((vehicleBase == null) || (!(vehicleBase instanceof net.minecraft.server.v1_7_R1.Entity))) {
/* 144:168 */       return;
/* 145:    */     }
/* 146:171 */     net.minecraft.server.v1_7_R1.Entity entity = (net.minecraft.server.v1_7_R1.Entity)vehicleBase;
/* 147:    */     try
/* 148:    */     {
/* 149:174 */       ReflectionUtils.setPrivateField(net.minecraft.server.v1_7_R1.Entity.class, this, "g", Double.valueOf(0.0D));
/* 150:175 */       ReflectionUtils.setPrivateField(net.minecraft.server.v1_7_R1.Entity.class, this, "h", Double.valueOf(0.0D));
/* 151:    */     }
 ...
 * Qualified Name:     com.gmail.filoghost.holographicdisplays.nms.v1_7_R1.EntityNMSSlime
