...
/*   9:    */ import net.minecraft.server.v1_8_R2.AxisAlignedBB;
/*  10:    */ import net.minecraft.server.v1_8_R2.DamageSource;
/*  11:    */ import net.minecraft.server.v1_8_R2.EntityDamageSource;
/*  12:    */ import net.minecraft.server.v1_8_R2.EntityPlayer;
/*  13:    */ import net.minecraft.server.v1_8_R2.EntitySlime;
/*  14:    */ import net.minecraft.server.v1_8_R2.NBTTagCompound;
/*  15:    */ import net.minecraft.server.v1_8_R2.World;
/*  16:    */ import org.bukkit.Bukkit;
/*  17:    */ import org.bukkit.craftbukkit.v1_8_R2.entity.CraftEntity;
...
/* 145:    */   {
/* 146:171 */     if ((vehicleBase == null) || (!(vehicleBase instanceof net.minecraft.server.v1_8_R2.Entity))) {
/* 147:173 */       return;
/* 148:    */     }
/* 149:176 */     net.minecraft.server.v1_8_R2.Entity entity = (net.minecraft.server.v1_8_R2.Entity)vehicleBase;
/* 150:    */     try
/* 151:    */     {
/* 152:179 */       ReflectionUtils.setPrivateField(net.minecraft.server.v1_8_R2.Entity.class, this, "ar", Double.valueOf(0.0D));
/* 153:180 */       ReflectionUtils.setPrivateField(net.minecraft.server.v1_8_R2.Entity.class, this, "as", Double.valueOf(0.0D));
/* 154:    */     }
 ...
 * Qualified Name:     com.gmail.filoghost.holographicdisplays.nms.v1_8_R2.EntityNMSSlime
