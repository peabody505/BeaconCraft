...
/*  19:    */ import net.minecraft.server.v1_8_R2.Chunk;
/*  20:    */ import net.minecraft.server.v1_8_R2.ChunkProviderServer;
/*  21:    */ import net.minecraft.server.v1_8_R2.EntityTypes;
/*  22:    */ import net.minecraft.server.v1_8_R2.MathHelper;
/*  23:    */ import net.minecraft.server.v1_8_R2.WorldServer;
/*  24:    */ import org.apache.commons.lang.NotImplementedException;
/*  25:    */ import org.bukkit.Bukkit;
/*  26:    */ import org.bukkit.craftbukkit.v1_8_R2.CraftWorld;
/*  27:    */ import org.bukkit.craftbukkit.v1_8_R2.entity.CraftEntity;
...
/*  43:    */     {
/*  44: 44 */       this.validateEntityMethod = net.minecraft.server.v1_8_R2.World.class.getDeclaredMethod("a", new Class[] { net.minecraft.server.v1_8_R2.Entity.class });
...
/*  53:    */     {
/*  54: 53 */       Class<?> entityTypesClass = Class.forName("net.minecraft.server.v1_8_R2.EntityTypes");
...
/* 107:    */   }
/* 108:    */   
/* 109:    */   private boolean addEntityToWorld(WorldServer nmsWorld, net.minecraft.server.v1_8_R2.Entity nmsEntity)
/* 110:    */   {
/* 111:108 */     Validator.isTrue(Bukkit.isPrimaryThread(), "Async entity add");
/* 112:110 */     if (this.validateEntityMethod == null) {
/* 113:111 */       return nmsWorld.addEntity(nmsEntity, CreatureSpawnEvent.SpawnReason.CUSTOM);
/* 114:    */     }
/* 115:114 */     int chunkX = MathHelper.floor(nmsEntity.locX / 16.0D);
/* 116:115 */     int chunkZ = MathHelper.floor(nmsEntity.locZ / 16.0D);
/* 117:117 */     if (!nmsWorld.chunkProviderServer.isChunkLoaded(chunkX, chunkZ))
/* 118:    */     {
/* 119:119 */       nmsEntity.dead = true;
/* 120:120 */       return false;
/* 121:    */     }
/* 122:123 */     nmsWorld.getChunkAt(chunkX, chunkZ).a(nmsEntity);
/* 123:124 */     nmsWorld.entityList.add(nmsEntity);
/* 124:    */     try
/* 125:    */     {
/* 126:127 */       this.validateEntityMethod.invoke(nmsWorld, new Object[] { nmsEntity });
/* 127:    */     }
...
/* 137:    */   {
/* 138:137 */     return ((CraftEntity)bukkitEntity).getHandle() instanceof NMSEntityBase;
/* 139:    */   }
/* 140:    */   
/* 141:    */   public NMSEntityBase getNMSEntityBase(org.bukkit.entity.Entity bukkitEntity)
/* 142:    */   {
/* 143:143 */     net.minecraft.server.v1_8_R2.Entity nmsEntity = ((CraftEntity)bukkitEntity).getHandle();
/* 144:144 */     if ((nmsEntity instanceof NMSEntityBase)) {
/* 145:145 */       return (NMSEntityBase)nmsEntity;
/* 146:    */     }
/* 147:148 */     return null;
/* 148:    */   }
/* 149:    */   
...
/* 151:    */   {
/* 152:153 */     return new FancyMessageImpl(text);
/* 153:    */   }
/* 154:    */   
 ...
 * Qualified Name:     com.gmail.filoghost.holographicdisplays.nms.v1_8_R2.NmsManagerImpl
