...
/*  10:    */ import net.minecraft.server.v1_7_R4.Blocks;
/*  11:    */ import net.minecraft.server.v1_7_R4.EntityHuman;
/*  12:    */ import net.minecraft.server.v1_7_R4.EntityItem;
/*  13:    */ import net.minecraft.server.v1_7_R4.EntityPlayer;
/*  14:    */ import net.minecraft.server.v1_7_R4.NBTTagCompound;
/*  15:    */ import net.minecraft.server.v1_7_R4.NBTTagList;
/*  16:    */ import net.minecraft.server.v1_7_R4.NBTTagString;
/*  17:    */ import net.minecraft.server.v1_7_R4.World;
/*  18:    */ import org.bukkit.craftbukkit.v1_7_R4.entity.CraftEntity;
/*  19:    */ import org.bukkit.craftbukkit.v1_7_R4.inventory.CraftItemStack;
...
/*  46:    */   }
/*  47:    */   
/*  48:    */   public net.minecraft.server.v1_7_R4.ItemStack getItemStack()
/*  49:    */   {
...
/* 118:    */   {
/* 119:141 */     net.minecraft.server.v1_7_R4.ItemStack newItem = CraftItemStack.asNMSCopy(stack);
/* 120:143 */     if (newItem == null) {
/* 121:144 */       newItem = new net.minecraft.server.v1_7_R4.ItemStack(Blocks.BEDROCK);
/* 122:    */     }
...
/* 163:    */   {
/* 164:190 */     if ((vehicleBase == null) || (!(vehicleBase instanceof net.minecraft.server.v1_7_R4.Entity))) {
/* 165:192 */       return;
/* 166:    */     }
/* 167:195 */     net.minecraft.server.v1_7_R4.Entity entity = (net.minecraft.server.v1_7_R4.Entity)vehicleBase;
/* 168:    */     try
/* 169:    */     {
/* 170:198 */       ReflectionUtils.setPrivateField(net.minecraft.server.v1_7_R4.Entity.class, this, "g", Double.valueOf(0.0D));
/* 171:199 */       ReflectionUtils.setPrivateField(net.minecraft.server.v1_7_R4.Entity.class, this, "h", Double.valueOf(0.0D));
/* 172:    */     }
 ...
 * Qualified Name:     com.gmail.filoghost.holographicdisplays.nms.v1_7_R4.EntityNMSItem
