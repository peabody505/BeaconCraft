...
/*   8:    */ import net.minecraft.server.v1_6_R3.EntityHorse;
/*   9:    */ import net.minecraft.server.v1_6_R3.NBTTagCompound;
/*  10:    */ import net.minecraft.server.v1_6_R3.World;
/*  11:    */ import org.bukkit.craftbukkit.v1_6_R3.entity.CraftEntity;
/*  12:    */ 
...
/*  85:    */   {
/*  86:111 */     if ((name != null) && (name.length() > 64)) {
/*  87:112 */       name = name.substring(0, 64);
/*  88:    */     }
...
/* 137:    */   {
/* 138:163 */     if ((vehicleBase == null) || (!(vehicleBase instanceof net.minecraft.server.v1_6_R3.Entity))) {
/* 139:165 */       return;
/* 140:    */     }
/* 141:168 */     net.minecraft.server.v1_6_R3.Entity entity = (net.minecraft.server.v1_6_R3.Entity)vehicleBase;
/* 142:    */     try
/* 143:    */     {
/* 144:171 */       ReflectionUtils.setPrivateField(net.minecraft.server.v1_6_R3.Entity.class, this, "f", Double.valueOf(0.0D));
/* 145:172 */       ReflectionUtils.setPrivateField(net.minecraft.server.v1_6_R3.Entity.class, this, "g", Double.valueOf(0.0D));
/* 146:    */     }
 ...
 * Qualified Name:     com.gmail.filoghost.holographicdisplays.nms.v1_6_R3.EntityNMSHorse
