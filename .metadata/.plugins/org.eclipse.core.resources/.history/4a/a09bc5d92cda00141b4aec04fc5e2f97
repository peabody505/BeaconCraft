...
/*   7:    */ import net.minecraft.server.v1_8_R1.AxisAlignedBB;
/*   8:    */ import net.minecraft.server.v1_8_R1.DamageSource;
/*   9:    */ import net.minecraft.server.v1_8_R1.EntityArmorStand;
/*  10:    */ import net.minecraft.server.v1_8_R1.EntityHuman;
/*  11:    */ import net.minecraft.server.v1_8_R1.EntityPlayer;
/*  12:    */ import net.minecraft.server.v1_8_R1.ItemStack;
/*  13:    */ import net.minecraft.server.v1_8_R1.NBTTagCompound;
/*  14:    */ import net.minecraft.server.v1_8_R1.PacketPlayOutEntityTeleport;
/*  15:    */ import net.minecraft.server.v1_8_R1.PlayerConnection;
/*  16:    */ import net.minecraft.server.v1_8_R1.Vec3D;
/*  17:    */ import net.minecraft.server.v1_8_R1.World;
/*  18:    */ import org.bukkit.craftbukkit.v1_8_R1.entity.CraftEntity;
...
/*  37:    */     try
/*  38:    */     {
/*  39: 35 */       ReflectionUtils.setPrivateField(EntityArmorStand.class, this, "bg", Integer.valueOf(2147483647));
/*  40:    */     }
 ...
 * Qualified Name:     com.gmail.filoghost.holographicdisplays.nms.v1_8_R1.EntityNMSArmorStand
