...
/*   8:    */ import net.minecraft.server.v1_7_R4.EntityHorse;
/*   9:    */ import net.minecraft.server.v1_7_R4.NBTTagCompound;
/*  10:    */ import net.minecraft.server.v1_7_R4.World;
...
/* 137:    */   {
/* 138:163 */     if ((vehicleBase == null) || (!(vehicleBase instanceof net.minecraft.server.v1_7_R4.Entity))) {
/* 139:165 */       return;
/* 140:    */     }
/* 141:168 */     net.minecraft.server.v1_7_R4.Entity entity = (net.minecraft.server.v1_7_R4.Entity)vehicleBase;
/* 142:    */     try
/* 143:    */     {
/* 144:171 */       ReflectionUtils.setPrivateField(net.minecraft.server.v1_7_R4.Entity.class, this, "g", Double.valueOf(0.0D));
/* 145:172 */       ReflectionUtils.setPrivateField(net.minecraft.server.v1_7_R4.Entity.class, this, "h", Double.valueOf(0.0D));
/* 146:    */     }
 ...
 * Qualified Name:     com.gmail.filoghost.holographicdisplays.nms.v1_7_R4.EntityNMSHorse
