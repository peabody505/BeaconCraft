...
/*   9:    */ import net.minecraft.server.v1_7_R3.DamageSource;
/*  10:    */ import net.minecraft.server.v1_7_R3.EntityDamageSource;
/*  11:    */ import net.minecraft.server.v1_7_R3.EntityPlayer;
/*  12:    */ import net.minecraft.server.v1_7_R3.EntitySlime;
/*  13:    */ import net.minecraft.server.v1_7_R3.NBTTagCompound;
/*  14:    */ import net.minecraft.server.v1_7_R3.World;
/*  15:    */ import org.bukkit.Bukkit;
/*  16:    */ import org.bukkit.craftbukkit.v1_7_R3.entity.CraftEntity;
...
/* 142:    */   {
/* 143:166 */     if ((vehicleBase == null) || (!(vehicleBase instanceof net.minecraft.server.v1_7_R3.Entity))) {
/* 144:168 */       return;
/* 145:    */     }
/* 146:171 */     net.minecraft.server.v1_7_R3.Entity entity = (net.minecraft.server.v1_7_R3.Entity)vehicleBase;
/* 147:    */     try
/* 148:    */     {
/* 149:174 */       ReflectionUtils.setPrivateField(net.minecraft.server.v1_7_R3.Entity.class, this, "g", Double.valueOf(0.0D));
/* 150:175 */       ReflectionUtils.setPrivateField(net.minecraft.server.v1_7_R3.Entity.class, this, "h", Double.valueOf(0.0D));
/* 151:    */     }
 ...
 * Qualified Name:     com.gmail.filoghost.holographicdisplays.nms.v1_7_R3.EntityNMSSlime
