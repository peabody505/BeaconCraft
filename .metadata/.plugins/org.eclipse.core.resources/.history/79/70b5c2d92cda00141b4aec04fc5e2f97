...
/*  10:    */ import net.minecraft.server.v1_8_R2.Blocks;
/*  11:    */ import net.minecraft.server.v1_8_R2.DamageSource;
/*  12:    */ import net.minecraft.server.v1_8_R2.EntityHuman;
/*  13:    */ import net.minecraft.server.v1_8_R2.EntityItem;
/*  14:    */ import net.minecraft.server.v1_8_R2.EntityPlayer;
/*  15:    */ import net.minecraft.server.v1_8_R2.NBTTagCompound;
/*  16:    */ import net.minecraft.server.v1_8_R2.NBTTagList;
/*  17:    */ import net.minecraft.server.v1_8_R2.NBTTagString;
/*  18:    */ import net.minecraft.server.v1_8_R2.World;
/*  19:    */ import org.bukkit.craftbukkit.v1_8_R2.entity.CraftEntity;
/*  20:    */ import org.bukkit.craftbukkit.v1_8_R2.inventory.CraftItemStack;
...
/*  47:    */   }
/*  48:    */   
/*  49:    */   public net.minecraft.server.v1_8_R2.ItemStack getItemStack()
/*  50:    */   {
...
/* 122:    */   {
/* 123:147 */     net.minecraft.server.v1_8_R2.ItemStack newItem = CraftItemStack.asNMSCopy(stack);
/* 124:149 */     if (newItem == null) {
/* 125:150 */       newItem = new net.minecraft.server.v1_8_R2.ItemStack(Blocks.BEDROCK);
/* 126:    */     }
...
/* 167:    */   {
/* 168:196 */     if ((vehicleBase == null) || (!(vehicleBase instanceof net.minecraft.server.v1_8_R2.Entity))) {
/* 169:198 */       return;
/* 170:    */     }
/* 171:201 */     net.minecraft.server.v1_8_R2.Entity entity = (net.minecraft.server.v1_8_R2.Entity)vehicleBase;
/* 172:    */     try
/* 173:    */     {
/* 174:204 */       ReflectionUtils.setPrivateField(net.minecraft.server.v1_8_R2.Entity.class, this, "ar", Double.valueOf(0.0D));
/* 175:205 */       ReflectionUtils.setPrivateField(net.minecraft.server.v1_8_R2.Entity.class, this, "as", Double.valueOf(0.0D));
/* 176:    */     }
 ...
 * Qualified Name:     com.gmail.filoghost.holographicdisplays.nms.v1_8_R2.EntityNMSItem
