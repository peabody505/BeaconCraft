...
/*   7:    */ import net.minecraft.server.v1_7_R4.EntityWitherSkull;
/*   8:    */ import net.minecraft.server.v1_7_R4.NBTTagCompound;
/*   9:    */ import net.minecraft.server.v1_7_R4.PacketPlayOutEntityTeleport;
/*  10:    */ import net.minecraft.server.v1_7_R4.PlayerConnection;
/*  11:    */ import net.minecraft.server.v1_7_R4.World;
/*  12:    */ import org.bukkit.craftbukkit.v1_7_R4.entity.CraftEntity;
...
/* 103:    */   {
/* 104:121 */     super.setPosition(x, y, z);
/* 105:    */     
/* 106:    */ 
/* 107:124 */     PacketPlayOutEntityTeleport teleportPacket = new PacketPlayOutEntityTeleport(this);
/* 108:126 */     for (Object obj : this.world.players) {
/* 109:127 */       if ((obj instanceof EntityPlayer))
/* 110:    */       {
/* 111:128 */         EntityPlayer nmsPlayer = (EntityPlayer)obj;
/* 112:    */         
/* 113:130 */         double distanceSquared = Utils.square(nmsPlayer.locX - this.locX) + Utils.square(nmsPlayer.locZ - this.locZ);
/* 114:131 */         if ((distanceSquared < 8192.0D) && (nmsPlayer.playerConnection != null)) {
/* 115:132 */           nmsPlayer.playerConnection.sendPacket(teleportPacket);
/* 116:    */         }
/* 117:    */       }
/* 118:    */     }
/* 119:    */   }
...
/* 122:    */   {
/* 123:140 */     return this.dead;
/* 124:    */   }
/* 125:    */   
/* 126:    */   public int getIdNMS()
/* 127:    */   {
/* 128:145 */     return getId();
/* 129:    */   }
/* 130:    */   
/* 131:    */   public CraftHologramLine getHologramLine()
/* 132:    */   {
/* 133:150 */     return this.parentPiece;
/* 134:    */   }
/* 135:    */   
/* 136:    */   public Entity getBukkitEntityNMS()
/* 137:    */   {
/* 138:155 */     return getBukkitEntity();
/* 139:    */   }
/* 140:    */ }


/* Location:           C:\Users\Rufus\Downloads\HolographicDisplays.jar
 * Qualified Name:     com.gmail.filoghost.holographicdisplays.nms.v1_7_R4.EntityNMSWitherSkull
