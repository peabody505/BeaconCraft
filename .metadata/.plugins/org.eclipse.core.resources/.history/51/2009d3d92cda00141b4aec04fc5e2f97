...
/*  19:    */ import net.minecraft.server.v1_7_R3.Chunk;
/*  20:    */ import net.minecraft.server.v1_7_R3.ChunkProviderServer;
/*  21:    */ import net.minecraft.server.v1_7_R3.EntityTypes;
/*  22:    */ import net.minecraft.server.v1_7_R3.MathHelper;
/*  23:    */ import net.minecraft.server.v1_7_R3.WorldServer;
/*  24:    */ import org.apache.commons.lang.NotImplementedException;
/*  25:    */ import org.bukkit.Bukkit;
/*  26:    */ import org.bukkit.craftbukkit.v1_7_R3.CraftWorld;
/*  27:    */ import org.bukkit.craftbukkit.v1_7_R3.entity.CraftEntity;
...
/*  44:    */     {
/*  45: 45 */       this.validateEntityMethod = net.minecraft.server.v1_7_R3.World.class.getDeclaredMethod("a", new Class[] { net.minecraft.server.v1_7_R3.Entity.class });
...
/*  54:    */     {
/*  55: 54 */       Class<?> entityTypesClass = Class.forName("net.minecraft.server.v1_7_R3.EntityTypes");
...
/* 109:    */   }
/* 110:    */   
/* 111:    */   private boolean addEntityToWorld(WorldServer nmsWorld, net.minecraft.server.v1_7_R3.Entity nmsEntity)
/* 112:    */   {
...
/* 144:    */   {
/* 145:146 */     net.minecraft.server.v1_7_R3.Entity nmsEntity = ((CraftEntity)bukkitEntity).getHandle();
 ...
 * Qualified Name:     com.gmail.filoghost.holographicdisplays.nms.v1_7_R3.NmsManagerImpl
